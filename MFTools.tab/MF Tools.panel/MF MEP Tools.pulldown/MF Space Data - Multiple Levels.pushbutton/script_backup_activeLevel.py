...
t = Transaction(doc, 'Mark Boundary Inserts with Detail Lines')
...
MF_WriteToExcel("SpaceData2", "SpaceData", spaceList)

MF_WriteToExcel("SpaceData4", "AllSpaceSummary", allSpacesSummary)
