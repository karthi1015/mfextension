# -*- coding: utf-8 -*-
__title__ = 'MF Space Data - Multiple Levels'
__doc__ = """Space Magic
"""
...
allLevelSpacesSummary.append(["Level", "Flat", "Flat Type", "Space Id", "Space Name", "Room Type", "Floor Area", "Height", "Gross External Area", "Net External Wall Area", "Total Windows", "Total External Window Area", "Total Doors", "Total External Door Area"])


allLevelSpaceData = []
allLevelSpaceData.append(["Level", "Flat", "Flat Type", "Space Id", "Space Name", "Room Type", "Boundary Length", "Height", "Gross Boundary Area", "Net Boundary Area", "Start", "End", "Boundary Normal", "Boundary Generated By Element (Id)", "Boundary Element Name", "Boundary Type", "Inserts"])
...
##levels = levels[2:]  ## temp debug hack
...
for level in levels:
	...
	spaceList = []
	spaceList.append(["Level", "Flat", "Flat Type", "Space Id", "Space Name", "Room Type", "Boundary Length", "Height", "Gross Boundary Area", "Net Boundary Area", "Start", "End", "Boundary Normal", "Boundary Generated By Element (Id)", "Boundary Element Name", "Boundary Type", "Inserts"])
	...
	drawLines = False
	allSpacesSummary = []
	allSpacesSummary.append( ["Level", "Flat", "Flat Type", "Space Id", "Space Name", "Room Type", "Floor Area", "Height", "Gross External Area", "Net External Wall Area", "Total Windows", "Total External Window Area", "Total Doors", "Total External Door Area"])
	for space in spaces:
		...
		if space.Location: # placed spaces only
			...
			## create a list here
				...
				#except Exception as e: 
					...
					try:
						...
						spaceFlatType = space.LookupParameter("Flat Type").AsString()
					...
					try:
						...
						roomType = space.LookupParameter("MF Room Type").AsString()
					...
					list = [currentLevel.Name, spaceFlatName, spaceFlatType, space.Id, spaceName, roomType, cLength, storeyHeight,  bArea, netBoundaryArea, str(cStart), str(cEnd) , str(cNormal), bEId, bEName, bType, str(inserts)]	
			...
			spaceSummary = [currentLevel.Name, spaceFlatName, spaceFlatType, space.Id, spaceName, roomType, spaceFloorArea, storeyHeight, spaceGrossExteriorWallArea, spaceExteriorWallArea, spaceExteriorWindowCount, spaceExteriorWindowArea, spaceExteriorDoorCount, spaceExteriorDoorArea]
		allSpacesSummary.append(spaceSummary)	
	
	allLevelSpaceData.extend(spaceList[1:])
	allLevelSpacesSummary.extend(allSpacesSummary[1:])	
...
MF_WriteToExcel("Space Data - All Levels", "allLevelSpaceData", allLevelSpaceData)

MF_WriteToExcel("Space Summary - All Levels", "allLevelSpacesSummary", allLevelSpacesSummary)
